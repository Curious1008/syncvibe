...
#[inline]
pub fn brand() -> Style { Style::new().fg(SV_ACCENT).add_modifier(Modifier::BOLD) }

#[inline]
pub fn section_label() -> Style { Style::new().fg(SV_FG_MUTED) }

#[inline]
pub fn body() -> Style { Style::new().fg(SV_FG) }

#[inline]
pub fn own_mention() -> Style { Style::new().fg(SV_ACCENT).add_modifier(Modifier::BOLD) }

#[inline]
pub fn timestamp() -> Style { Style::new().fg(SV_FG_MUTED) }

#[inline]
pub fn system() -> Style { Style::new().fg(SV_FG_DIM).add_modifier(Modifier::ITALIC) }

#[inline]
pub fn placeholder() -> Style { Style::new().fg(SV_FG_FAINT) }

#[inline]
pub fn selected_bg() -> Style { Style::new().bg(SV_ELEVATED) }

#[inline]
pub fn error() -> Style { Style::new().fg(SV_ERROR) }
...
mod tests {
    ...
    fn semantic_fns_compose_expected_styles() {
        assert_eq!(brand(), Style::new().fg(SV_ACCENT).add_modifier(Modifier::BOLD));
        assert_eq!(system(), Style::new().fg(SV_FG_DIM).add_modifier(Modifier::ITALIC));
