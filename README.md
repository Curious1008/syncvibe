...
> *Two developers collaborating with their AI agents (Codex + Claude) in real time. [Watch full demo](https://github.com/Curious1008/syncvibe/releases/download/v0.4.3/SyncVibe-Demo.mp4)*
